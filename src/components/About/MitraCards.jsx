    ...
    return (
        <div className="flex flex-col justify-center items-center w-full container mx-auto py-10 gap-4 px-4 mt-20 md:mt-28">
            ...
            <div className="flex flex-wrap justify-center items-center gap-10" data-aos='fade-right' data-aos-duration='1500' data-aos-delay='400'>
                <img src="/mitra/sucaber.png" alt="sucaber" className="w-[360px]" />
                <img src="/mitra/matic.png" alt="matic" className="w-[200px]" />
                <img src="/mitra/dewytex.png" alt="dewytex" className="w-[300px]" />
                <img src="/mitra/bakery.png" alt="bakery" className="w-[200px]" />
                <img src="/mitra/aaj.png" alt="aaj" className="w-[200px]" />
                <img src="/mitra/novatex.png" alt="novatex" className="w-[350px]" />
                <img src="/mitra/id.png" alt="" className="w-[160px]" />
                <img src="/mitra/bcp.png" alt="bcp" className="w-[200px]" />
                <img src="/mitra/msra.png" alt="msra" className="w-[300px]" />
                <img src="/mitra/sharon.png" alt="sharon" className="w-[300px]" />
                <img src="/mitra/stl.png" alt="stl" className="w-[200px]" />
                <img src="/mitra/ilike.png" alt="ilike" className="w-[200px]" />
            </div>
        </div>
    )
}
