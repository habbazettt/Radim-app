    ...
    return (
        <div className="w-full flex flex-col gap-16 py-8">
            ...
            <div className="flex flex-col md:flex-row gap-8 justify-start items-center p-6 md:p-0">
                <img src="/service-cards/service-1.png" alt="" className="max-w-full md:max-w-[50%]" data-aos="fade-right" data-aos-duration="1500" />
            ...
            <div className="flex flex-col-reverse md:flex-row gap-8 justify-end items-center p-6 md:p-0">
                ...
                <img src="/service-cards/service-2.png" alt="" className="max-w-full md:max-w-[50%]" data-aos="fade-right" data-aos-duration="1500" />
            </div>
